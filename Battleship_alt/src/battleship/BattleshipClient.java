...
public class BattleshipClient {   
	...
	public void results()
	{
		...
		{
			Battleship.getPlayers(1).setBboard(x,y,new ImageIcon("1.png"));
		...
		else if (results.startsWith("hit"))
		{
			...
			if (results.startsWith("shipsunk"))
			{
				...
				{					
					for (i=x;i<=endp;i++)
					{
						Battleship.getPlayers(1).setBboard(i,y,new ImageIcon("1.png"));
					}
				}
				else
				{
					for (i=y;i<=endp;i++)
					{
						Battleship.getPlayers(1).setBboard(x,i,new ImageIcon("1.png"));
					}					
				}
			}			
			else
		...
		else if (results.startsWith("theirshot"))
		{
			...
			if (!Battleship.getPlayers(0).getWhatShip(x,y).equals(" "))
			{
				...
				if (!Battleship.getPlayers(0).isSunk(x,y
					...
					Battleship.getPlayers(0).setBboard(x,y,new ImageIcon("1.png"));
			}
			else
			  Battleship.getPlayers(0).setBboard(x,y,new ImageIcon("1.png"));
